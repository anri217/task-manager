...
public class AddTaskWindowController {
    ...
    public void clickAdd(ActionEvent actionEvent) throws Exception {
        ...
        Task task;
        task = factory.createTask(nameTextField.getText(), descTextArea.getText(), new LocalDateTime(datePicker.getValue().getYear() - 1900, datePicker.getValue().getMonthValue()-1,  datePicker.getValue().getDayOfMonth(), Integer.parseInt(hoursTextField.getText()), Integer.parseInt(minTextField.getText())), Status.PLANNED);
