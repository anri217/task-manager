...
public class test {
    public static void main(String[] args) throws JsonProcessingException {
        ...
        client.CommandController.parse_Command(jsonParser.getCommand()); // на клиентском command controler распаршиваем пришедшую команду на command_id и map. - это имитация того, что клиенту пришла команда
